...
//     for (int i = 1; i < 11; i++)
//     {
//         cout << n << " X " << i << "=" << i * n << ". Hello World " << endl;
//         printf("Hello\n");
//     }
//     return 0;
// }
...
//     Employee sauvik("Sauvik constructor", 344, 324432);
// sauvik.name = "sauvik";
// sauvik.salary = 100;
//     sauvik.printDetails();
//     sauvik.getSecretPassword();
// cout<<sauvik.secretPassword;
// cout<<"The name of our first employee is "<< sauvik.name << " and his salary is "<<sauvik.salary<<" Dollars"<<endl;
//     return 0;
// }
